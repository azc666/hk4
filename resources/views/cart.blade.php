            ...
            <table class="table">
                ...
                <tbody>
                    @foreach (Cart::content() as $item)
                        ...
                        @if ($prod_layout == 'fbc' || $prod_layout == 'fbc6' || $prod_layout == 'srbc' || $prod_layout == 'cbc' || $prod_layout == 'cbc6' || $prod_layout == 'srbc6' || $prod_layout == 'dsbc' || $prod_layout == 'dsbc6')
                            {!! Form::select('qty', array('Select Quantity', '100' => '100 / $50', '250' => '250 / $69', '500' => '500 / $75', '1000' => '1000 / $89'), ['class' => 'quantity move-down'], ['style' => 'font-size:12px']) !!}
                        @endif
                         @if ($prod_layout == 'psrbc' || $prod_layout == 'psrbc6')
                            {!! Form::select('qty', array('Select Quantity', '100' => '100 / $50', '250' => '250 / $84', '500' => '500 / $95', '1000' => '1000 / $115'), ['class' => 'quantity move-down'], ['style' => 'font-size:12px']) !!}
                        @endif
                        @if ($prod_layout == 'lbl' || $prod_layout == 'lbl6' || $prod_layout == 'clbl' || $prod_layout == 'clbl6' || $prod_layout == 'dslbl' || $prod_layout == 'dslbl6')  
                            {!! Form::select('qty', array('Select Quantity', '100' => '100 / $50', '250' => '250 / $71', '500' => '500 / $91', '1000' => '1000 / $135'), ['class' => 'quantity move-down'], ['style' => 'font-size:12px']) !!}
                        @endif
                        @if ($prod_layout == 'cnp' || $prod_layout == 'cnp6' || $prod_layout == 'np' || $prod_layout == 'np6' || $prod_layout == 'dsnp' || $prod_layout == 'dsnp6')  
                            {!! Form::select('qty', array('Select Quantity', '4' => '4 Pads / $69', '8' => '8 Pads / $85'), ['class' => 'quantity move-down'], ['style' => 'font-size:12px']) !!}
                        @endif
                        @if ($prod_layout == 'lh' || $prod_layout == 'lh6' || $prod_layout == 'dslh' || $prod_layout == 'dslh6' || $prod_layout == 'clh' || $prod_layout == 'clh6')  
                            {!! Form::select('qty', array('Select Quantity', '100' => '100 / $50', '250' => '250 / $84', '500' => '500 / $115', '1000' => '1000 / $180'), ['class' => 'quantity move-down'], ['style' => 'font-size:12px']) !!}
                        @endif
