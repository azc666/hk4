...
{!! Form::open(['data-parsley-validate' => '', 'route' => 'editProfile', 'method' => 'post']) !!}     <br>  
    ...
    <div class="form-group">
        <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-home fa-lg" aria-hidden="true" data-toggle="tooltip" title="Enter your full legal name / dba"></i>&nbsp;&nbsp;Builder Company Name:</span>
            {{ Form::text('loc_name', $user->loc_name, ['class' => 'form-control', 'placeholder' => 'Builder Company Name', 'required' => '',]) }}  
        </div>
    </div>
