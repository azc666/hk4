...
<div class="container"> 
  ...
  @if ($request->prod_id == 1 || $request->prod_id == 2 || $request->prod_id == 3 || $request->prod_id == 4 || $request->prod_id == 10 || $request->prod_id == 11 || $request->prod_id == 12 || $request->prod_id == 13 || $request->prod_id == 7 || $request->prod_id == 16 || $request->prod_id == 21 || $request->prod_id == 22 || $request->prod_id == 27 || $request->prod_id == 28|| $request->prod_id == 29 || $request->prod_id == 30 || $request->prod_id == 31 || $request->prod_id == 32 || $request->prod_id == 33 || $request->prod_id == 34 || $request->prod_id == 19 || $request->prod_id == 20)
...
{{-- /////////////////// Franchise & Design Studio LH & Env ////////////////// --}}
  @if ($request->prod_id == 8 || $request->prod_id == 9 || $request->prod_id == 17 || $request->prod_id == 18 || $request->prod_id == 35 || $request->prod_id == 36 || $request->prod_id == 37 || $request->prod_id == 38) 
   <div class="form-group">
        {!! Form::label('address1', 'Address1:', ['class' => 'move-down col-sm-2 control-label']) !!}
      <div class="col-sm-10 control-text move-down">
  ...
  <div class="form-inline">
    ...
    <div class="form-group">
        {!! Form::label('state', 'State:', ['class' => 'move-down col-sm-2 control-label']) !!}
      <div class="col-sm-3 control-text move-down">
          {!! Form::text('state', null, ['class' => 'form-control', 'placeholder' => 'State']) !!}
      </div>
      {!! Form::label('zip', 'Zip:&nbsp;&nbsp;&nbsp;', ['class' => 'move-down col-sm-2 control-label-zip']) !!}
      <div class="col-sm-3 control-text-zip move-down">
          {!! Form::text('zip', null, ['class' => 'form-control', 'placeholder' => 'Zip']) !!}
      </div>
    </div>
    <br><br>

    @if ($request->prod_id == 8 || $request->prod_id == 17 || $request->prod_id == 37 || $request->prod_id == 38)  {{--  Phone fields for LH Only --}}
      <div class="form-group">
          {!! Form::label('phone', 'Phone:', ['class' => 'move-down col-sm-2 control-label']) !!}
        <div class="col-sm-4 control-text move-down">
