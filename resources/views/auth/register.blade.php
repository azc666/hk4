...
<br>
    ...
    <div class="panel-heading text-center">Create a New User <br>You will be redirected to "Login" to complete/modify the user's "My Profile"<br><i>(Please note: You cannot modify the Username nor BC# once created.)</i></div>
    <div class="panel-body">
        ...
        <div class="input-group">
            ...
            {{ Form::text('loc_num', null, ['class' => 'form-control', 'placeholder' => 'Builder Company #', 'required' => '', 'unique' => '']) }}
        </div>
        ...
        <div class="input-group move-down">
            ...
            {{ Form::text('loc_name', null, ['class' => 'form-control', 'placeholder' => 'Builder Company Name', 'required' => '', 'unique' => '']) }}
        </div>
