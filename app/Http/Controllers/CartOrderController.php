        ...
        
    {
       ...
       if ($request->confirm) {
        ...
        foreach (Cart::content() as $item) {
            ...
            <a href="' . url(substr_replace($item->options->proofPath, 'pdf', -3)) . '" target="_blank"><img src="' . url($item->options->proofPath) . '" style="max-width:300px;" alt="proof" class="img-responsive cart-image move-right dropshadow"></a>
            </td>
...
//////////////////////  CREATE $cartOrderProduction  /////////////////////////////
  ...
  //dd($order);      
        ...
        // \Mail::to('support@arhorderportal.com')->send(new OrderProductionEmail($cartOrderProduction));
